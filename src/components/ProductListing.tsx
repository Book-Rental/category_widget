...
import { Rb_Button, ProductCard, Pagination, Dropdown } from "rentbook";
...
const [showDuration, setShowDuration] = useState<Record<string, boolean>>({});
  ...
  {showDuration[product._id] ? (
    <div className="flex items-center gap-2">
      <div className="flex-1">
        <Dropdown
          placeholder="Select Days for Rent"
